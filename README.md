...
When submitting data to the lab, please fill out [the data submission file](https://drive.google.com/file/d/1l9y5PCKQHvCOral-PPGMuISEeKcDbYK8/view?usp=sharing) and send it to [clauwaer@umich.edu](mailto:clauwaer@umich.edu). Please keep the `.csv` file format after editing. as such, do not use comma’s within field entries.
